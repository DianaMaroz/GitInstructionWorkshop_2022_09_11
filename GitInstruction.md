...
* возвращаться к различным версиям
* обеспечивать работу над сложным проектом в несколько этапов
* одновременно работать над проектом нескольким разработчикам
